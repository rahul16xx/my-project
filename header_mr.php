...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="115" align="center" valign="top" background="images/index_04.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="364" align="center" valign="middle"><img src="images/Vohra_brothers_vector.jpg" width="420" height="96" /></td>
        <td height="115">&nbsp;</td>
              ...
              <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					<td width="30%" align="center" valign="middle"><a href="home.php" class="mostlink">My Profile </a></td>
  ...
  <tr>
    <td align="left"><table border="0" cellspacing="0" cellpadding="0" align="center">
      <tr height="23">
		...
		$sel_menu_qr = "select * from menu_master where parent_menu='0' ";
	...
	$nav_res = mysql_fetch_assoc($nav_qr);
		if($nav_res['parent_menu'] == '0')
		{
			...
			{	
				...
				{
				echo "<a href='".$ch_nav_qr['menu_lnk']."?menu=".$ch_nav_res['menu_id']."' class='s_link'>".$ch_nav_res['menu_name']."</a> <img src='images/r_arrowmain.gif'> <a href='".$nav_res['menu_lnk']."?menu=".$nav_res['menu_id']."' class='s_link'>".$nav_res['menu_name']."</a>";
				}
			}
		}
		...
		else
		{
			...
			echo "<a href='menu_right.php?menu=".$fnl_nav_res['menu_id']."' class='s_link'>".$fnl_nav_res['menu_name']."</a> </a> <img src='images/r_arrowmain.gif'> <a href='".$nav_res['menu_link']."?menu=".$nav_res['menu_id']."' class='s_link'>".$nav_res['menu_name']."</a>";
		}
		if($_GET['M'])
		{
		$wsql="select * from menu_master where menu_id='$_GET[M]'";
		$wsql_rec=mysql_query($wsql);
		$wsql_res=mysql_fetch_assoc($wsql_rec);
		echo "<a href='menu_right.php?menu=".$wsql_res['menu_id']."' class='s_link'>".$fnl_nav_res['menu_name']."</a> </a> <img src='images/r_arrowmain.gif'> <a href='menu_right.php?menu=".$_GET['menu']."&U=".$_GET['U']."' class='s_link'>".$wsql_res['menu_name']."</a>";
		}
	}?></td>
