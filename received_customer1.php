			...
			?>
              ...
              <tr>
				...
				<td width="42%" align="center" class="note"><?php if($vs == 1){?><img src="images/red.gif" width="24" height="24" /><br />
				  Not Sent To Vendor<?php }elseif($vs == 2){?><img src="images/yellow.gif" width="24" height="24" /><br />Sent To Vendor<?php }elseif($vs == 3){?><img src="images/green.gif" width="24" height="24" /><br />Received From Vendor. <br>Dt. : <?php echo $rdt; if($nsl){echo "<br>New Sl. No. : <b>".$nsl."</b>";} }?></td>
              </tr>
			  <tr>
