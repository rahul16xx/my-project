    ...
    <td align="left" valign="top" bgcolor="#FBFAFA"><table width="85%" border="0" align="center" cellpadding="0" cellspacing="0" class="tabsborder2">
      ...
      <tr>
        ...
        <td height="120" colspan="2" align="center" valign="middle" class="mostbtext"><form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return chk_nullV();">
		  ...
		  <tr>
              <td width="22%" height="25" align="right">Party Challan Number     </td>
              <td width="3%" align="center">:</td>
              <td width="23%" align="left" class="pad_l note">
			  <select name="challan" id="challan" onchange="chk_unique()">
 ...
 *</td>
              <td width="22%" align="right">Select Product   </td>
              <td width="3%" align="center">:</td>
              <td width="27%" align="left" class="pad_l note"><div id="areaHint" style="visibility:visible; text-align:left"><?php include "chk_unique.php";?></div></td>
			</tr>
            <tr>
			...
			<tr>
              ...
              <td width="3%" align="center">:</td>
              <td width="23%" align="left" class="pad_l note"><select name="vendor" id="vendor" tabindex="2">
                ...
                *</td>
              <td width="22%" align="right">Purchase Bill Number  </td>
              <td width="3%" align="center">:</td>
              <td width="27%" align="left" class="pad_l note"> <input name="pbill" type="text" id="pbill" /></td>
			</tr>
            <tr>
              <td colspan="6" align="right" height="10"></td>
            </tr>
			<tr>
              ...
              <td width="3%" align="center">:</td>
              <td width="23%" align="left" class="pad_l note"><script>DateInput('dpb', true, 'YYYY-MM-DD')</script><!--<input name="challan" type="text" id="challan" tabindex="1" />-->
                
                </td>
              <td width="22%" align="right">&nbsp; </td>
              <td width="3%" align="center">&nbsp;</td>
              <td width="27%" align="left" class="pad_l note">&nbsp; </td>
			</tr>
            <tr>
              <td colspan="6" align="right" height="10"></td>
            </tr>
